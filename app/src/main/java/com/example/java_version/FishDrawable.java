...
public class FishDrawable extends Drawable {
    ...
    //鱼鳍的长度
    private float FINS_LENGTH = 1.5f * HEAD_RADIUS;
    //大圆半径
...
//        结束点
 ...
 //        控制点
        PointF controlPoint = calculatePoint(startPoint,FINS_LENGTH * 2f,
 ...
 * * pixelFormat. OPAOUE:便是完全不透明，遮盖在他下面的所有内容
